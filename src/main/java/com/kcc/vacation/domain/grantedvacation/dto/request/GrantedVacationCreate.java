...
public class GrantedVacationCreate {
    ...
    @Builder
    public GrantedVacationCreate(int id, int vacation_days, Timestamp granted_date, Timestamp expiration_date, String description, int vacation_type_id, int emp_id, int admin_id) {
        this.id = id;
