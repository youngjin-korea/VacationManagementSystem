...
<div id="mainContent" class = "container d-flex justify-content-center align-items-center" style="height: 80vh;">
    <div class = "col-6 d-flex flex-column">
        ...
        <button class="d-flex btn btn-white mb-4 border text-color-gray1" type="button">
            ...
            <p style="margin:0px;">Google 계정으로 로그인</p>
        </button>
        <button class="d-flex  btn btn-dark  mb-4 border text-color-gray1" style="background-color:#FFE812;" type="button">
            <div class ="col-4 d-flex justify-content-end ms-4  me-2 login-img">
                <img src="/resources/assets/kakaotalk.png" alt="Logo" />
            </div>
            <p style="margin:0px;">카카오 계정으로 로그인</p>
        </button>
